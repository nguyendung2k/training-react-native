      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
          ...
          >
            <View style={styles.contentHeader}>
              <Header
                ...
                onDirection={() =>
                  navigation.navigate("UpdateProfileScreen", idUserParam)
                }
        ...
        <View style={styles.content}>
          <View style={styles.btnFollow}>
            <ButtonComponent
              label="1234"
              IconRight={<IconUsersDual stroke={COLORS.Semantic5} />}
            ...
            <ButtonComponent
              ...
              styleBtn={[styles.btn, styles.default]}
              styleText={[styles.txtBtnDefault, { color: COLORS.Semantic2 }]}
            />
            <ButtonComponent
              label="1234"
              IconRight={
                <IconCoin width={20} height={20} stroke={COLORS.Semantic1} />
              }
              styleBtn={[styles.btn, styles.default]}
              styleText={[styles.txtBtnDefault, { color: COLORS.Semantic1 }]}
            />
          </View>
          ...
          <Text style={styles.textIntroduction}>{userDetail.introduction}</Text>
          {/* ------- */}
        ...
        <View style={styles.blockActiveLog}>
          <TouchableOpacity style={styles.notification}>
            ...
            <Notification
              ...
              active
              Icon={() => {
                return <IconDotNotification fill={COLORS.Semantic2} />;
              }}
            />
          </TouchableOpacity>
          <TouchableOpacity style={styles.notification}>
            ...
            <Notification
              ...
              time="9 Jul 2021, 12:00AM "
              active
              Icon={() => <IconDotNotification fill={COLORS.Semantic2} />}
            />
          </TouchableOpacity>
          <TouchableOpacity style={styles.notification}>
            <Image
