          ...
          {({
            ...
            <View style={{ marginHorizontal: 24 }}>
              <InputComponent
                ...
                value={values.email}
                error={touched.email && <MessageError error={errors.email} />}
                style={styles.input}
              />
              <InputComponent
                title="Password"
                ...
                isPassword
                error={
                  touched.password && <MessageError error={errors.password} />
                }
                style={styles.input}
              />
              <InputComponent
                ...
                error={
                  touched.username && <MessageError error={errors.username} />
                }
                style={styles.input}
              />
              ...
              <View style={styles.inputDrop}>
                <View style={styles.inputItemGender}>
                  <InputDrop
                    ...
                    error={
                      touched.gender && <MessageError error={errors.gender} />
                    }
                    primary
                  />
                </View>
                ...
                <View style={styles.inputItemBirth}>
                  <InputDrop
                    ...
                    error={
                      touched.birth_year && (
                        <MessageError error={errors.birth_year} />
                      )
                    }
                    primary
                  />
              ...
              <View style={styles.footer}>
                <CheckBox
                  Icon={<IconCheck stroke={COLORS.Neutral0} />}
                  check={checkBox}
                  onPress={() => setCheckBox(!checkBox)}
                />
                <Text>
                  I agree to the <Text />
                  <Text style={styles.footerTxtPrimary}>Terms of Use</Text>
                </Text>
              </View>
              ...
              <View style={styles.btn}>
                <ButtonComponent
                  label="Submit"
                  disabled={!checkBox}
                  styleBtn={!checkBox ? styles.btnUnCheckbox : styles.btnCheck}
                  styleText={!checkBox ? styles.btnText : styles.textUnCheck}
                  onPress={handleSubmit}
                  Icon={
                    <ArrowRight
                      stroke={!checkBox ? COLORS.Neutral3 : COLORS.Neutral0}
                    />
                  }
                />
              </View>
