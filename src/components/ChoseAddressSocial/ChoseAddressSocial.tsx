...
const socialNetwork = [
  {
    label: <Image source={require("../../assets/images/LogoFacebook.png")} />,
    value: "Facebook",
  },
  {
    label: (
  ...
  {
    label: <Image source={require("../../assets/images/logos_twitter.png")} />,
    value: "Twitter",
  },
  {
    label: (
      <Image source={require("../../assets/images/logos_youtube-icon.png")} />
    ),
    value: "Youtube",
  },
];
